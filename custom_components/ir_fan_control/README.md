...
> **Quick Start**
> 1. Install (**one-click HACS** recommended, or **manual** fallback)
> 2. Add integration: **Settings -> Devices & Services -> Add Integration -> IR Fan Control**

One-click add to HACS:

[![Open your Home Assistant instance and open this repository inside Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=Tipana&repository=ir_fan_control&category=integration)
...
## Install
### Step 1A (recommended): One-click HACS install
...
### Step 1B (fallback): Manual install
...
## Screenshots
<p>
  <img src="docs/fan-heater-tile-size.png" alt="Fan and heater tiles" height="280" />
  <img src="docs/fan-preset-mode-menu.png" alt="Preset mode menu" height="280" />
</p>
